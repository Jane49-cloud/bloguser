...
import { fetchPopularPosts } from "@/redux/blogsSlice";
...
const PopularBlogs = () => {
  const { PopularPosts, isLoading } = useSelector((state: any) => state.Blogs);
