...
import { fetchHousePosts } from "@/redux/blogsSlice";
...
const HouseBlogs = () => {
  const { HousePosts, isLoading } = useSelector((state: any) => state.Blogs);
